...
Product_Id = ["B00004WCCL"]  #second product
...
# finding the most common words for each sentiment category
...
# Print the most common words for each sentiment category
